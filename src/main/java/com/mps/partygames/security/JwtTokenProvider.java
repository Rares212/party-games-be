package com.mps.partygames.security;
...
public class JwtTokenProvider implements Serializable {
    private Key key = Keys.hmacShaKeyFor(JwtConstants.SIGNIN_KEY.getBytes());
    ...
    public UsernamePasswordAuthenticationToken getAuthToken(final String token, final Authentication existingAuth, final UserDetails userDetails) {
